...
function calculateLeadScore(lead) {
  ...
  if (maxBudget > 100000) score += 30;else
  if (maxBudget > 50000) score += 25;else
  if (maxBudget > 25000) score += 20;else
  if (maxBudget > 10000) score += 15;else
  if (maxBudget > 5000) score += 10;else
  if (maxBudget > 0) score += 5;
