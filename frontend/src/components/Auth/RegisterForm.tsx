        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-primary-100 leading-relaxed">
              Join thousands of construction professionals who trust SiteBoss 
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-primary-100">Comprehensive Project Management</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-primary-300 rounded-full mr-4"></div>
              <span className="text-primary-100">Real-time Team Collaboration</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-primary-300 rounded-full mr-4"></div>
              <span className="text-primary-100">Advanced Budget Analytics</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-primary-300 rounded-full mr-4"></div>
              <span className="text-primary-100">Integrated Document Management</span>
            </div>
          </div>
        </div>
        {/* Decorative elements */}
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-3 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-colors"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-colors"
                >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-3 py-3 pr-10 border border-gray-300 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 sm:text-sm transition-colors"
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>Want to explore first? Use <span className="font-mono font-semibold">demo@siteboss.com</span> with any password</p>
                  </div>
                </div>
              </div>
            </div>
